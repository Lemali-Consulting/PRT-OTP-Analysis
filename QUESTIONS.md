...
- How do we ensure the analyses is replicable?
- How should we organize data? Should each analysis be in its own directory, with a METHODS.md file detailing what is done?